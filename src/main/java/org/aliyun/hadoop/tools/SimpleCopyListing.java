...
import org.aliyun.hadoop.tools.util.ProducerConsumer;
import org.aliyun.hadoop.tools.util.WorkReport;
import org.aliyun.hadoop.tools.util.WorkRequest;
import org.aliyun.hadoop.tools.util.WorkRequestProcessor;
...
public class SimpleCopyListing extends CopyListing {
  ...
  private void addToFileListing(SequenceFile.Writer fileListWriter,
    ...
    final boolean preserveAcls = context.shouldPreserve(DistCpOptions.FileAttribute.ACL);
    final boolean preserveXAttrs = context.shouldPreserve(DistCpOptions.FileAttribute.XATTR);
   ...
   * {@link DistCpSync#sync}. An item can be
   ...
   * See {@link DistCpUtils#getRelativePath} for
