...
public class DistCpUtils {
   ...
   * @throws CopyListing.AclsNotSupportedException if fs does not support ACLs
   */
  public static void checkFileSystemAclSupport(FileSystem fs)
    ...
    try {
      ...
      throw new CopyListing.AclsNotSupportedException("ACLs not supported for file system: "
        + fs.getUri());
    }
  }
   ...
   * 
   * @param fs FileSystem to check
   * @throws CopyListing.XAttrsNotSupportedException if fs does not support XAttrs
   */
  public static void checkFileSystemXAttrSupport(FileSystem fs)
    ...
    try {
      ...
      throw new CopyListing.XAttrsNotSupportedException("XAttrs not supported for file system: "
        + fs.getUri());
    }
  }
